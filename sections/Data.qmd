...
# county_map + 
#   geom_sf(data = camplocations_df, aes(geometry=geometry), color = "red")
```
...
data %>% 
  ungroup() %>% 
  summarise(
    across(dist_GilaRiver:dist_HeartMt), mean(.,na.rm = TRUE) / 1000)
  )
```

## Population and Migration

```{r download-ipums, eval=FALSE}
